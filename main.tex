...
\begin{enumerate}[label=]
    ...
    % TODO: Which model to use. Commenting this out to put it in the objectives as discussed
    %In this project, we will learn and use:
    %\begin{enumerate}[label=\arabic*.]
     % \item Logistic Regression + Decision Tree + Neural Network % Maybe? ADrien: I think we can do just ARIMA without moving average.
